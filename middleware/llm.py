...
class ReportProcessor:
    ...
    def __generate(self, promt:str):
        return self.__llm.chat(promt).choices[0].message.content
    ...
    def report(self, data: SalesData):
        report = f"""Прочитай все задание целиком прежде чем выполнять!
                    ...
                    ведь нам его представлять начальству, не отображай результаты кодом на питоне.
                    """
